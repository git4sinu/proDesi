...
<style>
    .step-tabs .nav-tabs li a { padding: 13px 80px !important; }
</style>
...
<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 same-9 no-print" id="sig-in">
    <div class="step-tabs">
        <ul id="myTab" class="nav nav-tabs step breadcrum">
            ...
            <li <c:if test="${!empty model.bucketData.id && model.bucketData.paymentStatus}">class="active"</c:if>><a>Step 3<p>see or download Results</p></a></li>
        </ul>
        ...
        <div class="form-step-1">
            ...
            <form class="form-horizontal buck1" role="form" action="${propath}/home/showRegister" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control number" name="angle" id="jangle"  required='required' placeholder="RAD" onblur="store('jangle','angle');" value="${model.bucketData.angle}">
                    </div>
                </div>
